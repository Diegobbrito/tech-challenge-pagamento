...
public class PagamentoController {
    ...
    @Operation(summary = "Consulta de pagamento")
    @GetMapping("/{pedidoId}")
    public ResponseEntity<PagamentoResponse> detalheDePagamentoDoPedido(@Parameter(example = "1") @PathVariable Integer pedidoId) {
        return ResponseEntity.ok(gerenciarPagamentoUseCase.consultarPagamento(pedidoId));
    }
